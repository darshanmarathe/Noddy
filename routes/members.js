...
exports.mynodds = function (req, res) {
    ...
    _noddRepo.getNodds(req.user[0].Email, function (docs) {
        ...
        res.render('members/mynodds', { title: 'Your nodds', model: docs, user: req.user[0], layout: 'userLayout' });
    })
}
exports.index = function (req, res) {
    ...
    _noddRepo.getNodds(req.user[0].Email, function (docs) {
        ...
        res.render('members/index', { title: 'Your nodds', model: docs, user: req.user[0], layout: 'userLayout' });
    })
}
